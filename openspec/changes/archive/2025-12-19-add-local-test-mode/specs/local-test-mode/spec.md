# Local Test Mode Publisher Specification Delta

## Overview

Add support for a local test mode that outputs the final markdown content to the terminal (stdout) instead of publishing to external services. This enables developers to test the full export pipeline locally without affecting GitHub repositories or Telegram channels.
