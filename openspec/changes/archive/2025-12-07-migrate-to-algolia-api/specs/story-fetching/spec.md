# Spec: Story Fetching via Hybrid Firebase + Algolia API

## Overview

Story fetching using a hybrid approach: Firebase (for "best" story IDs) and Algolia (for efficient batch details), enabling date-range filtering and score-based sorting.
