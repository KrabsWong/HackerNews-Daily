# Worker Source Abstraction Specification Delta

## Overview

This delta introduces a `ContentSource` abstraction to enable the worker to support multiple content sources (HackerNews, Reddit, ProductHunt, etc.) through a common interface.
