...
## Overview
Introduces a provider abstraction layer for LLM API calls, enabling support for multiple LLM providers (DeepSeek, OpenRouter) with a unified interface.
...
**And** requires `DEEPSEEK_API_KEY` to be set
